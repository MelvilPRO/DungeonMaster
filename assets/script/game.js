...
export class Game {
    ...
    getRandomMonsters () {
        ...
        for (let i = 0; i < GameInterface.MaxStepNum - 1; i++) {
            ...
            switch (monsterType){
                case Spider.MonsterType:
                    monsterCurr = new Spider(2, 3, 100, this.backgroundDom);
                    break;
                case Skeleton.MonsterType:
                    monsterCurr = new Skeleton(3, 4, 100, this.backgroundDom);
                    break;
        ...
        gameMonsters.push(new Boss(4, 5, 100, this.backgroundDom));
        return gameMonsters;
    }
