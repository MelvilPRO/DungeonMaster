export class Creature {
    ...
    #health;    // INT
    #images;    // [STR_PATH]
    #target;    // CLASS INSTANCE CREATURE/HEROS
    ...
    set SetHealth(tmp){
        if (tmp <= 0){
            this.#health = 0;
            console.log("La créature: " + this.#nom + " est décédée!");
        } else if (tmp > Creature.maxHealth){
            this.#health = Creature.maxHealth;
            console.log("Les points de vie ne peuvent exceder: " + Creature.maxHealth + " la créature a maintenant: " + Creature.maxHealth + " points de vie");
        } else {
            this.#health = tmp;
        }
    }
